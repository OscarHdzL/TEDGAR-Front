...
@Component({
  selector: "app-modulo-registros-toma-nota",
  templateUrl: "./modulo-registros-toma-nota.component.html",
  styleUrls: ["./modulo-registros-toma-nota.component.css"],
  providers: [ServiceGenerico],
})
/** modulo-reporte-registro component*/
export class ModuloRegistrosTomaNotaComponent implements OnInit {
  ...
  inicializatabla() {
    ...
    this.dtOptions = {
      ...
      columnDefs: [
        {
          targets: [3, 6], // Esto apunta a las columnas de fecha
  ...
  public ConsultaDatos(): void {
    ...
    this.services
      .HttpPost(
        params,
        `${this.servicios.serviciosOperaciones}/ConsultaListaRegistrosTomaNota/ConsultaListaRegistros`
      )
      .subscribe(
        (response: any) => {
  ...
  eliminarTnota(id_tnota: number) {
    ...
    this.services
      .HttpPost(
        params,
        `${this.servicios.serviciosOperaciones}/EliminarRegistroTomaNota/EliminarRegistro`
      )
      .subscribe(
        (response: any) => {
          this.operacionRespuesta.EstaEjecutando = false;
  ...
  mandarNotificaciones(id_tramite: number) {
    this.router.navigate(["/consulta-toma-nota/" + id_tramite]);
  }
