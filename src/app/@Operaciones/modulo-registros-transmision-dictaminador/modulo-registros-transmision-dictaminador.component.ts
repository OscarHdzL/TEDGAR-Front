...
import { DatosReporteRequest, DatosReporteTramiteResponse } from '../../model/Operaciones/reportes/ReportesRegistro';
...
@Component({
    selector: 'app-modulo-registros-transmision-dictaminador',
  templateUrl: './modulo-registros-transmision-dictaminador.component.html',
  styleUrls: ['./modulo-registros-transmision-dictaminador.component.css'],
  providers: [ServiceGenerico]
})
/** modulo-reporte-transmision component*/
export class ModuloRegistrosTransmisionDictaminadorComponent implements OnInit {
  ...
  public ConsultaDatos(): void {
    ...
    this.services.HttpPost(params, `${this.servicios.serviciosOperaciones}/ConsultaListaRegistrosTransmisionDictaminador/ConsultaListaRegistrosTransmision`)
  ...
  eliminarTransmision(id_transmision: number) {
    ...
    this.services.HttpPost(params, `${this.servicios.serviciosOperaciones}/EliminarRegistroTransmision/EliminarRegistro`)
      .subscribe((response: any) => {
        this.operacionRespuesta.EstaEjecutando = false;
