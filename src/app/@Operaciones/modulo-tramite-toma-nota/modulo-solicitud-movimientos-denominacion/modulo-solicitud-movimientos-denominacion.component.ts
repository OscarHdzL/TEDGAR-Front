...
@Component({
  selector: 'app-modulo-solicitud-movimientos-denominacion',
  templateUrl: './modulo-solicitud-movimientos-denominacion.component.html',
  styleUrls: ['./modulo-solicitud-movimientos-denominacion.component.css'],
  providers: [ServiceGenerico]
})
/** modulo-solicitud-movimientos-denominacion component*/
export class ModuloSolicitudMovimientosDenominacionComponent implements OnInit{
  ...
  formGroup: FormGroup;
  /** modulo-solicitud-movimientos-denominacion ctor */
