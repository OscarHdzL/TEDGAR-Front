...
@Component({
  selector: 'app-modulo-registros-tramite-dictaminador',
  templateUrl: './modulo-registros-tramite-dictaminador.component.html',
  styleUrls: ['./modulo-registros-tramite-dictaminador.component.css'],
  providers: [ServiceGenerico]
})
/** modulo-reporte-registro component*/
export class ModuloRegistrosTramiteDictaminadorComponent implements OnInit {
  ...
  public ConsultaDatos(): void {
    ...
    const params = {
      ...
      numero_sgar: this.formFiltros.get('nombre').value,
      estatus_desc: this.formFiltros.get('estatus').value,
      denominacion_desc: this.formFiltros.get('denominacion').value

    }
    this.services.HttpPost(params, `${this.servicios.serviciosOperaciones}/ConsultaListaRegistrosTramiteDictaminador/ConsultaListaRegistrosTramiteDictaminador`)
  ...
  eliminarTramite(id_tramite: number) {
    ...
    this.services.HttpPost(params, `${this.servicios.serviciosOperaciones}/EliminarRegistroTramite/EliminarRegistro`)
      .subscribe((response: any) => {
        this.operacionRespuesta.EstaEjecutando = false;
  ...
  mandarModificacion(id_tramite: number) {
    ...
    if (id_tramite) {
      this.localStorageService.setJsonValue('solicitudregistroconsulta', params);
